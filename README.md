...
MIT License — Copyright (c) 2025 Abhi
All Rights Reserved License

This software and associated documentation files (the "Software") are the exclusive intellectual property of Abhi. Unauthorized copying, distribution, modification, or commercial use of the Software is strictly prohibited.

You are granted permission to download and use the Software **as-is** for personal or educational purposes only. You **may not**:

- Copy, modify, or merge the Software
- Publish, sublicense, or distribute the Software
- Sell or profit directly or indirectly from the Software
- Rename or rebrand the Software
- Claim ownership or authorship of any part of the Software
